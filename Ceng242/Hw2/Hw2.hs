...
--prey listinin sort halini reverse gönder
...
listim = ([(Prey {pID = 2, pEnergy = 99, pActions = [N,W,S,E,E]},(3,0)),(Prey {pID = 1, pEnergy = 69, pActions = [W,E,W,E,W]},(1,0))],[(Hunter {hID = 2, hlevel = Newbie, hEnergy = 69, hNumberOfCatches = 0, hActions = [N,S,W,E,N]},(1,2)),(Hunter {hID = 1, hlevel = Expert, hEnergy = 89, hNumberOfCatches = 2, hActions = [S,N,E,S,W]},(3,1))])
